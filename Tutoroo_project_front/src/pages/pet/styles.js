...
// [게임 화면] 펫 이미지 동적 스타일 (상태값 적용)
export const petImage = (isSleeping) => css`
  height: 280px;
  object-fit: contain;
  transition: all 0.5s ease;
  filter: drop-shadow(0 10px 10px rgba(0, 0, 0, 0.2));

  /* 상태 1: 자는 중 (어둡게, 흑백, 애니메이션 없음) */
  ${isSleeping &&
  css`
